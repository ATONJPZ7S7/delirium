...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Delirium server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Delirium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Delirium features */
        {"delirium", "masternode", &masternode, true, true, false},
        {"delirium", "listmasternodes", &listmasternodes, true, true, false},
        {"delirium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"delirium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"delirium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"delirium", "masternodedebug", &masternodedebug, true, true, false},
        {"delirium", "startmasternode", &startmasternode, true, true, false},
        {"delirium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"delirium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"delirium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"delirium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"delirium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"delirium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"delirium", "mnbudget", &mnbudget, true, true, false},
        {"delirium", "preparebudget", &preparebudget, true, true, false},
        {"delirium", "submitbudget", &submitbudget, true, true, false},
        {"delirium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"delirium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"delirium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"delirium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"delirium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"delirium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"delirium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"delirium", "checkbudgets", &checkbudgets, true, true, false},
        {"delirium", "mnsync", &mnsync, true, true, false},
        {"delirium", "spork", &spork, true, true, false},
        {"delirium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"delirium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use deliriumd, or the -server option to delirium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Delirium Alert\" admin@foo.com\n"),
...
{
    return "> delirium-cli " + methodname + " " + args + "\n";
}
