...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Delirium Core"),
     ...
     * override -datadir in the delirium.conf file in the default data directory
     * (to be consistent with deliriumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
