                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Delirium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DLC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and delirium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Delirium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Delirium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DLC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DLC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DLC addresses"));
    ...
    openAction->setStatusTip(tr("Open a DLC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Delirium Core help message to get a list with possible Delirium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Delirium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DLC network", "", count));
}
...
{
    QString strTitle = tr("Delirium Core"); // default title
