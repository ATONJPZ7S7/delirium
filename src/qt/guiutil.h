...
/** Utility functions used by the DLC Qt UI.
 */
namespace GUIUtil
{
...
// Render DLC addresses in monospace font
...
// Parse "delirium:" URI into recipient object, return true on successful parsing
