...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Delirium Core delirium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  delirium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded delirium transaction") + "\n" +
                               "  delirium-tx [options] -create [commands]   " + _("Create hex-encoded delirium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded delirium transaction
