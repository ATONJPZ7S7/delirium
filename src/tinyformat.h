...
// #define TINYFORMAT_USE_VARIADIC_TEMDLCES
...
#if !defined(TINYFORMAT_USE_VARIADIC_TEMDLCES) && !defined(TINYFORMAT_NO_VARIADIC_TEMDLCES)
...
#ifdef TINYFORMAT_USE_VARIADIC_TEMDLCES
