...
{
    //Delirium will hash in the transaction hash and the index number in order to make sure each hash is unique
...
//new nNewStakeMinAge 
//   if (chainActive.Tip()->nHeight >= SOFT_FORK_VERSION_1) {
        // Min age requirement
//        if (nTimeBlockFrom + nNewStakeMinAge > nTimeTx)  // Min age requirement
