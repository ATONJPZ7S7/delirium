...
In order to support loading of multiple wallets in delirium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is delirium.cpp.
...
Changes to delirium.cpp
----------------------
delirium.cpp is the entry point into delirium-qt, and as such, will require some minor modifications to provide hooks for
