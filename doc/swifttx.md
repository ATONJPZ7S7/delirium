...
This mechanism has been integrated into Bitcore-Node-DLC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DLC-Project/insight-api-delirium#web-socket-api](https://github.com/DLC-Project/insight-api-delirium#web-socket-api) 
* API: [https://github.com/DLC-Project/insight-api-delirium#swifttx-transactions](https://github.com/DLC-Project/insight-api-delirium#swifttx-transactions) 
...
By default, the DLC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DLC Core daemon:
