DLC Core version 2.3.0 is now available from:

  <https://github.com/delirium-project/delirium/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/delirium-project/delirium/issues>

Compatibility
==============

DLC Core is extensively tested on multiple operating systems using
...
DLC Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) DLC MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode DLC address
...
DLC Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for DLC (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with DLC (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/delirium-project-translations/).
